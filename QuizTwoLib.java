...
public class QuizTwoLib {
    ...
    public static int[] images =new int[]{
            ...
            R.drawable.bryophyllum9,R.drawable.compound11,R.drawable.cassava12,R.drawable.tropi,
            R.drawable.medicine14,R.drawable.iodine,R.drawable.simple10
    };
    public static boolean[] answers = new boolean[]{
            true, false, true, false, true, false, false, false, false, false, true, true, false, true ,false
    };
}
